...
const CHECKLIST = [
  ...
  },
  {
    ...
    catIcon: '📜',
    risk: 'High',
    title: 'Sanctioned building plans (all floors, all wings) handed over',
    why: 'Sanctioned plans are needed for any future structural changes, additions to common areas, or legal disputes about unauthorised construction.',
    how: 'Builder must hand over copies of all approved building plans from the Municipal Authority. Verify plans cover all structures including parking, amenity areas, and open spaces.',
  },
  {
